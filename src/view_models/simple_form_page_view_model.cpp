...
SimpleFormPageViewModel::SimpleFormPageViewModel(QObject* parent) : AbstractViewModel(parent)
{
    ...
    m_name->statusMessages()->addHelpMessage("Ciao!");
...
SimpleFormPageViewModel::~SimpleFormPageViewModel()
{
}


void SimpleFormPageViewModel::acceptButtonHandler()
{
    QString msg;
...
void SimpleFormPageViewModel::do_updateView()
{
